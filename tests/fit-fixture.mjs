...
export function makeFit({ serial = 12345, start = new Date('2025-04-06T03:00:00Z'), records = 30,
    omitSerial = false, extra = false, sport = 'running', subSport = 'generic' } = {}) {
    ...
    encoder.onMesg(Profile.MesgNum.SESSION, { startTime: start, timestamp: new Date(start.getTime() + 1800000),
        sport, subSport, totalTimerTime: 1800, totalElapsedTime: 1800, totalDistance: 5000 });
